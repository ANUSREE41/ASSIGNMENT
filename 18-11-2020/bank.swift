...
class AccountManager {
    ...
    func createAccountNumber(serialNumber: String) {
    ...
    func depositAmount(amount: Int, accountNumber: String) {
        ...
        for account in  accounts {
            ...
            if (account.accountNumber == accountNumber) {
                ...
                if (account.type == accountType.currentAccount || account.type == accountType.savingAccount || account.type == accountType.recurring) {
   ...
   func withdrawAmount(amount: Int, accountNumber: String) {
        ...
        for account in  accounts {
            ...
            if (account.accountNumber == accountNumber) {
                ...
                if (account.type == accountType.currentAccount || account.type == accountType.savingAccount || account.type == accountType.houseLoan || account.type == accountType.vehicleLoan || account.type == accountType.personLoan) {
...
accountManager1.createAccountNumber(serialNumber: "20")
